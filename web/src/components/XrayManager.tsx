  ...
  return <section>
    ...
    <div className="xray-layout">
      <div className="xray-installations">
        ...
        {discovery.installations.length === 0 ? <Card><StatePanel title="No Xray installation detected" description="Known standalone Xray, Marzban, and 3x-ui paths were checked without changing host state." action="Scan again" onAction={() => void load()} /></Card> : discovery.installations.map((installation) => <InstallationCard key={`${installation.kind}-${installation.config_path}`} installation={installation} />)}
      </div>
