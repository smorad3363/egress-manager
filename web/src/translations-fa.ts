export const faEntries: ReadonlyArray<readonly [string, string]> = [
  ["Language", "زبان"],
  ["English", "English"],
  ["Persian", "فارسی"],
  ...
  ["No matching page was found.", "بخشی با این نام پیدا نشد."],
  ...
  ["No Xray service detected", "سرویس Xray قابل مدیریتی پیدا نشد"],
  ["The Xray runtime bundled with Egress Manager is installed for validation and integration. This page manages an existing standalone Xray, Marzban, or 3x-ui service when one is found.", "هسته Xray همراه Egress Manager نصب است، اما این صفحه فقط یک سرویس Xray مستقل، Marzban یا 3x-ui موجود روی سرور را مدیریت می‌کند."],
